    ...
    <div class="nk-content-body">
        <div class="nk-block-head">
            <div class="nk-block-between g-3">
                ...
                <div class="nk-block-head-content">
                    <a id="back" onclick="loading('back')" href="{{ route('h.question.all') }}"
        ...
        <div class="card">
            <div class="card-inner">
                ...
                <form action="{{ route('h.question.creat') }}" class="gy-3" method="post">
                    @csrf
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    ...
                                    <input type="text"
                                           class="form-control form-control-lg @error('qnumber') error @enderror"
                                           value="{{ old('qnumber') }}" name="qnumber" id="qnumber">
                                    @error('qnumber')
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text"
                                           class="form-control form-control-lg @error('qtext') error @enderror"
                        ...
                        <div class="col-lg-1" style="width: 40;">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="1" name="true_gozine" id="true_gozine1">
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-1" style="width: 40;">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="2" name="true_gozine" id="true_gozine2">
                                    <label class="custom-control-label" for="true_gozine1"></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-1" style="width: 40;">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="3" name="true_gozine" id="true_gozine3">
                                    <label class="custom-control-label" for="true_gozine1"></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-1" style="width: 40;">
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="4" name="true_gozine" id="true_gozine4">
                                    <label class="custom-control-label" for="true_gozine1"></label>
                                </div>
                            </div>
                        </div>
