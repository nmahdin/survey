            ...
            <div class="nk-content-body">
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        ...
                        <div class="nk-block-head-content">
                            <a id="back" href="{{ route('h.question.all') }}" onclick="loading('back')"
                ...
                <div class="nk-block">
                    <div class="invoice">
                        <div class="card invoice-wrap">
                            ...
                            <div class="btn-edit">
                                <div class="btn-group" >
                                    <a href="/admin/h_questions/edit/{{$q_data->id}}" class="btn btn-dim btn-primary" ><span>ویرایش سوال</span> <em class="icon ni ni-edit-alt-fill"></em></a>
                                    <a href="/admin/h_questions/d/{{$q_data->id}}" class="btn btn-dim btn-danger"
                            ...
                            <form id="delete-q" action="/admin/h_questions/d/{{$q_data->id}}" method="POST" class="d-none">
                                @csrf
                                @method('delete')
                            </form>
                        </div>
