    ...
    <div class="nk-block nk-block-middle nk-auth-body">
        ...
        <form method="post" action="{{ route('admin.register') }}">
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input type="password" class="form-control form-control-lg @error('password_confirmation') error @enderror" name="password_confirmation" {{ old('password_confirmation') }} id="password_confirmation" required autofocus autocomplete="username" placeholder="رمز عبور را مجدد تکرار کنید">
