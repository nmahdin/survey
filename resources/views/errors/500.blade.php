<html lang="fa" class="js"><head>
    ...
    <!-- Page Title  -->
    <title>خطای 500 | خطای سرور</title>
    <!-- StyleSheets  -->
...
<!--                         <img class="nk-error-gfx" src="/assets/images/gfx/error-404.svg" alt=""> -->
                        <div class="wide-xs mx-auto">
                            <h3 class="nk-error-title">خطای سرور 500</h3>
                            <p class="nk-error-text">ما برای ناراحتی شما بسیار متاسفیم. به نظر می رسد سعی می کنید به صفحه ای دسترسی پیدا کنید که مشکلی در آن وجود دارد. لطفاً به مدیر اطلاع دهید.</p>
